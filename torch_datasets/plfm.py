...
class PlfmGanSarDataset(Dataset):
...
class PlfmLstmIterableDataset(IterableDataset):
    ...
    def __init__(
        ...
        if wrapped_dataset:
            ...
            self.map_dataset = PlfmLstmDataset(dataset_manager, mode=mode)
